...
{
    public sealed class TypeDescriptor // TODO: Rename to AwaitableTypeDescriptor
    {
        ...
        public bool IsAsyncType { get; } // TODO: Rename to IsAwaitable
    ...
    public readonly struct AsyncTypeAwaitable
    {
        ...
        public AsyncTypeAwaitable(TypeDescriptor asyncTypeDescriptor, object instance)
        {
            ...
            Debug.Assert(asyncTypeDescriptor.Type.IsAssignableFrom(instance.GetType()));
    ...
    public readonly struct AsyncTypeAwaiter : INotifyCompletion
    {
        ...
        internal AsyncTypeAwaiter(TypeDescriptor asyncTypeDescriptor, object instance)
        {
            ...
            if (asyncTypeDescriptor.IsAsyncType)
            {
                ...
                Debug.Assert(asyncTypeDescriptor.AwaiterType.IsAssignableFrom(_instanceOrAwaiter.GetType()));
            }
            else
            {
